...
import { UtensilsCrossed, Clock, Users, Heart, HeartHandshake, LogOut, Plus, Trash2 } from "lucide-react";
  ...
  const RecipeCard = ({ recipe, showDeleteButton = false }: { recipe: Recipe; showDeleteButton?: boolean }) => (
    <Card key={recipe.id} className="hover:shadow-xl transition-all duration-300 hover:-translate-y-1 border-0 shadow-lg overflow-hidden">
      <div className="h-48 bg-gradient-to-br from-orange-200 to-red-200 flex items-center justify-center">
        <UtensilsCrossed size={64} className="text-orange-600 opacity-50" />
      </div>
      <CardHeader>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-red-50 to-yellow-50 flex items-center justify-center">
        <div className="text-center">
          <UtensilsCrossed className="mx-auto mb-4 animate-spin" size={48} />
      ...
      <header className="bg-white shadow-sm border-b">
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-2xl font-bold text-gray-800">Let Us COOK</h1>
          </div>
          ...
          <TabsContent value="community">
            {recipes.length === 0 ? (
              <div className="text-center py-16">
                <UtensilsCrossed className="mx-auto mb-4 text-gray-400" size={64} />
